...
window = tk.Tk()
window.title("Fruit Adulteration and Grading...")
window.geometry("500x700")#500x510
window.configure(background ="#1e3a3b")
...
##            button.grid(column=0, row=9, padx=20, pady=20)
            ...
            r1.grid(column=0, row=4, padx=10, pady=10)
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\HP\\OneDrive\\Desktop\\fruitAdulteration_2_fruit\\dataset\\test', title='Select image for analysis ',
                           filetypes=[('image files', '.png')])
    dst = "C:\\Users\\HP\\OneDrive\\Desktop\\fruitAdulteration_2_fruit\\testpicture"
    print(fileName)
